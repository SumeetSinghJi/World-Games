...
{
    playerJackals = load_texture("assets/graphics/buttons/go/playerJackals.png", "Player Jackals");
    opponentJackals = load_texture("assets/graphics/buttons/go/opponentJackals.png", "Opponent Jackals");
